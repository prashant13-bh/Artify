      ...
      <div className="hidden lg:flex flex-1 relative bg-surface overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col justify-between p-12 h-full w-full">
          ...
          <div className="max-w-md">
            <h2 className="text-4xl font-black mb-4 leading-tight">Your imagination,<br/>our canvas.</h2>
            <p className="text-lg text-muted">Log in to track your SYOG orders, view your AI designs, and manage your custom wardrobe.</p>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input required type="email" placeholder="you@example.com" className="input-field" defaultValue="customer@makemywear.in" />
            </div>
            ...
            <button type="submit" disabled={isLoading} className="btn-glow w-full mt-2">
              {isLoading ? (
          ...
          <p className="mt-8 text-center text-sm gap-1 flex justify-center text-muted">
            ...
            <Link href="/register" className="text-foreground font-bold hover:text-accent transition-colors">Sign Up</Link>
          </p>
        </motion.div>
      </div>
    </div>
